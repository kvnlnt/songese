 ...
 *
 * <pre>
 *   songeseDev = angular.module('songeseDev', ['songese', 'ngMockE2E']);
 *   songeseDev.run(function($httpBackend) {
...
window.jasmine && (function(window) {
   ...
   * <pre>
   *
   *   angular.module('songeselicationModule', [])
   *       .value('mode', 'app')
   *       .value('version', 'v1.0.1');
   *
   *
   *   describe('songese', function() {
   *
   *     // You need to load modules that you want to test,
   *     // it loads only the "ng" module by default.
   *     beforeEach(module('songeselicationModule'));
   *
   *
